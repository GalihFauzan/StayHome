            ...
            if (move_uploaded_file($tmp, $file_destination)) {
                ...
                if ($update_invoice) {
                    ...
                    if ($update_tgl_sewa) {
                        ...
                        $insert_pembayaran = mysqli_query($conn, "INSERT INTO pembayaran (id_invoice, tanggal_pembayaran, jumlah_pembayaran,metode,foto) VALUES ('$id_invoice', '$tanggal_pembayaran', '$jumlah_bayar','$metode','$tanggal-$namafile')");
