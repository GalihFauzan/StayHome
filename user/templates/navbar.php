                ...
                <li class="nav-item dropdown">
                    <a class="nav-link dropdown-toggle pl-md-3 position-relative" href="javascript:void(0)" id="bell" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                        ...
                        <span class="badge badge-primary notify-no rounded-circle">
                            ...
                            $id = $_SESSION['id'];
                            $query = "SELECT * from invoice WHERE id_user='$id' AND status = 'Belum Dibayar'";
                            // Eksekusi query
                    ...
                    <div class="dropdown-menu dropdown-menu-left mailbox animated bounceInDown" style="width: 300px;">
                        <ul class="list-style-none">
                            <li>
                                ...
                                include "../assets/conn/koneksi.php";
                                $id = $_SESSION['id'];
                                $query = "SELECT invoice.id_invoice, invoice.tanggal_invoice, user.*, kamar.kamar, invoice.jumlah_invoice FROM invoice INNER JOIN user ON invoice.id_user = user.id_user INNER JOIN kamar ON user.id_kamar = kamar.id_kamar WHERE user.id_user='$id' AND invoice.status = 'Belum Dibayar'";
                                $result = mysqli_query($conn, $query);
