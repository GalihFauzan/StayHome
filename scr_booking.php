...
$query = mysqli_query($conn, "INSERT INTO user (nama_user,email,alamat,telp,id_kamar,id_bayar,password,tgl_sewa,keterangan)VALUES ('$nama_penyewa','$email','$alamat','$telp','$kamar','$pembayaran','$pass','$date','$ket')");
